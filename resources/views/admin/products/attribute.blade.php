                     ...
                     <div class="row">
                         <div class="col-md-8">
                           ...
                           <div class="row">
                            ...
                            <form action="{{route('addproductattr')}}" method="post">
                              @csrf
                              <div class="float-left mb-2">
                                 <a href="{{route('product.index')}}" class="btn btn-outline-info btn-sm">Cancel</a>
                              </div>
   ...
   <div class="modal fade" id="updateattrModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form class="updrec" method="post" action="{{route('updateproduct.attr')}}">
        @csrf
