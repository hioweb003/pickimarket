...
<head>
    ...
    <title>Reset Password | Picki Market Online Shopping</title>
            ...
            <div class="page-content mt-6 pb-2 mb-10">
                <div class="container">
                    ...
                    <div class="card">
                        ...
                        @endif
                            <form action="{{route('chngpass')}}" method="post">
                                @csrf
                                
                                <div class="form-group">
                                    <input type="password" class="form-control" id="singin-password" name="password" placeholder="New Password *" required />
                                    @error('password')
                                ...
                                <button class="btn btn-block btn-rounded cbtn2 mb-2" type="submit">Reset Password</button>
